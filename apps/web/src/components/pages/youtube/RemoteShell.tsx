...
import { SingersPrompt } from '@/components/singers/singers-prompt';
...
const SongRequest = dynamic(() => import('./SongRequest').then((mod) => mod.SongRequest), {
    loading: () => <RemoteShellSkeleton className="min-h-0 flex-1" />,
});
                ...
                <div className="relative flex h-full min-h-0 flex-col">
                    <RemotePanelOverlayProvider containOverlays>
                        <RemoteTabPanel>
                            ...
                            {currentTab === 'songRequest' && <SongRequest />}
