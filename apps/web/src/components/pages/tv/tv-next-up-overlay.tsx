...
import { RotateCcw, SkipForward, Mic2 } from 'lucide-react';
...
export function TvNextUpOverlay({
    ...
    const displaySeconds =
        isActive && remainingSeconds > 0 ? remainingSeconds : countdownSeconds;
                ...
                <div className="tv-next-up-overlay__layout">
                    ...
                    <div className="tv-next-up-overlay__content">
                        <div className="tv-next-up-overlay__meta">
                            ...
                            />
                            {nextVideo.singers?.length ? (
                                <p className="tv-next-up-overlay__singers">
                                    <Mic2 className="h-4 w-4" aria-hidden />
                                    {nextVideo.singers.join(', ')}
                                </p>
                            ) : null}
                        </div>
