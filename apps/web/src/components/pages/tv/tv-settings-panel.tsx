            ...
            >
                <div className="tv-settings-sections">
                    ...
                    <SettingsDropdown
                        ...
                        value={locale}
                        options={[
                            { value: 'es', label: tAppearance('languageSpanish') },
                    ...
                    <SettingsDropdown
                        {...scrollProps}
                        focusKey={TV_FOCUS_KEYS.settingsNextUpCountdown}
                        sectionLabel={tSections('nextUpCountdownLabel')}
                        icon={<Timer className="h-6 w-6" strokeWidth={2.5} aria-hidden />}
                        ...
                        onChangeAction={(value) => setCountdownSeconds(Number(value))}
                    />
