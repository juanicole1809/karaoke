export default {
    ...
    'settingsSections.nextUpCountdownLabel': 'Tạm dừng trước bài hát tiếp theo',
    'settingsSections.nextUpCountdownHint':
        'TV chờ bao lâu giữa bài hát này và bài hát tiếp theo.',
    ...
    'youtubePage.requestSong': 'Yêu cầu',
    ...
    'youtubePage.queueCountChip': '{count} bài chờ',

    'songRequest.hint': 'Nhập tên bài hát và nghệ sĩ. Chúng tôi sẽ tìm phiên bản karaoke hay nhất.',
    'songRequest.placeholder': 'vd: Persiana Americana - Soda Stereo',
    'songRequest.request': 'Tìm',
    'songRequest.searching': 'Đang tìm kiếm karaoke trên YouTube và xác thực…',
    'songRequest.error': 'Không tìm được bài hát. Thử lại hoặc dùng tab tìm kiếm.',
    'songRequest.playNow': 'Phát ngay',
    'songRequest.addToQueue': 'Thêm',
    'songRequest.declaration': 'Yêu cầu',
    'songRequest.topPick': 'Gợi ý hàng đầu',
    'songRequest.views': 'lượt xem',
    'songRequest.confidence': 'Khớp',
    'songRequest.karaoke': 'KARAOKE',
    'songRequest.noResults': 'Không tìm thấy bản karaoke phù hợp. Thử dùng tab tìm kiếm.',
    'songRequest.emptyState':
        'Không nghĩ ra bài hát? Tìm trực tiếp trên YouTube trong tab tìm kiếm.',
    'songRequest.agentLabel': 'Được xác thực bởi karaoke agent',

    'singers.title': 'Ai sẽ hát?',
    'singers.hint': 'Tên cách nhau bằng dấu phẩy. Để trống để bỏ qua.',
    'singers.placeholder': 'vd: Nam, Hoa',
    'singers.confirm': 'Thêm',
    'singers.solo': 'Không ghi tên',
    'singers.close': 'Đóng',
