export default {
    ...
    'settingsSections.nextUpCountdownLabel': 'Pause before next song',
    'settingsSections.nextUpCountdownHint':
        'How long the TV waits between one song and the next.',
    ...
    'youtubePage.requestSong': 'Request',
    ...
    'youtubePage.queueCountChip': '{count} in queue',

    'songRequest.hint': 'Type a song and artist. We\u2019ll find the best karaoke version for you.',
    'songRequest.placeholder': 'e.g. Persiana Americana - Soda Stereo',
    'songRequest.request': 'Find',
    'songRequest.searching': 'Searching YouTube for karaoke versions and validating…',
    'songRequest.error': 'Could not resolve the song. Please try again or use the search tab.',
    'songRequest.playNow': 'Play now',
    'songRequest.addToQueue': 'Add',
    'songRequest.declaration': 'Requested',
    'songRequest.topPick': 'Top pick',
    'songRequest.views': 'views',
    'songRequest.confidence': 'Match',
    'songRequest.karaoke': 'KARAOKE',
    'songRequest.noResults': 'No suitable karaoke version found. Try the search tab.',
    'songRequest.emptyState':
        'Can\u2019t think of a song? Search YouTube directly in the Search tab, or ask the guests next to you.',
    'songRequest.agentLabel': 'Validated by karaoke agent',

    'singers.title': "Who's singing?",
    'singers.hint': 'Separated by commas. Leave empty to skip.',
    'singers.placeholder': 'e.g. Anna, John',
    'singers.confirm': 'Add',
    'singers.solo': 'Just the song',
    'singers.close': 'Close',
